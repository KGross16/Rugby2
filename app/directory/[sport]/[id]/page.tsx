...
export default function PlayerProfile() {
  ...
  // Database of player stats, telemetry, and video links
  const database: Record<string, any> = {
    "mateo-rodriguez": {
      name: "Mateo Rodriguez", origin: "Argentina", age: 19, position: "Fly-Half / Center", 
      ...
      bio: "Elite playmaker from Buenos Aires with exceptional vision and tactical kicking game. Competing in international U20 developmental circuits, targeting US collegiate scholarships and MLR academies.",
      videoUrl: "https://www.youtube.com/embed/placeholder"
    },
    "santiago-silva": {
      name: "Santiago Silva", origin: "Uruguay", age: 20, position: "Flanker", 
    ...
    "liam-oconnor": {
      name: "Liam O'Connor", origin: "Canada", age: 18, position: "Prop / Lock", 
    ...
    "nicolas-herrera": {
      name: "Nicolas Herrera", origin: "Chile", age: 21, position: "Fullback", 
    ...
    "jaxson-miller": {
      name: "Jaxson Miller", origin: "USA", age: 19, position: "Scrum-Half", 
  ...
  const player = database[id] || {
    name: "Athlete Profile", origin: "Unknown", age: "N/A", position: "N/A",
    tier: "Pending", status: "Unverified", height: "N/A", weight: "N/A",
    metrics: { sprintSpeed: "N/A", maxOutput: "N/A" },
